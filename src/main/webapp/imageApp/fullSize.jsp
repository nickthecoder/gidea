...
<ww:pager items="${WEB_FILE.leaves}" itemsPerPage="5" subsetVar="subset" pagerVar="pager">
<tiles:insert template="imageTemplate.jsp">
    ...
    <c:forEach var="leaf" items="${subset}">
      <ww:linkInfo href="/image${leaf.encodedPath}">
        ...
        <div class="imageContainer">
            <ww:link><img alt="image" src="http://nickthecoder.co.uk/${leaf.resourceLocation}" /></ww:link>
            <br/>
  ...
  <c:if test="${! pager.singlePage}">
    <div class="pager">
      Page :
      <ww:linkInfo href="/images${WEB_FILE.encodedPath}?size=full">
